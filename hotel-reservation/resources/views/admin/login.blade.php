            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img style="width: 100%;height:80%;margin:0.5rem" src="{{asset('admin/img/annapurna.jpg')}}" alt=""><</div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    {{ Form::open(array('url' => 'annapurnahotel/admin/check')) }}
                                       @csrf 
